  ...
  return (
    <>
      <section id="Comp-Container">
        <ScrollAnimation animateIn="animate__fadeIn" duration={1.5} delay={100} animateOnce={true}>
        ...
        <ScrollAnimation animateIn="animate__fadeIn" duration={1.5} delay={100} animateOnce={true}>
          <div className="Comp-Card">
            ...
            <section className="Comp-Card-Text">
              ...
              <p>
                Primary knowledge with crossplatform development with dart
                across multiple projects and 2 internships in flutter framework.
                Have decent knowledge in native programming from working on a
                handful of school projects.
              </p>
            </section>
            <div className="Comp-Code-Icons">
          ...
          <div className="Comp-Card">
            ...
            <section className="Comp-Card-Text">
              ...
              <p>
                ...
                Comfortable with firebase and some of the extra provided
                services. Used it in my internship at Cetasol. Have basic
                understanding using mongodb databases.
              </p>
            </section>
            <div className="Comp-Code-Icons">
